# Revista T20 - Duelo de Dragões

![foundry-v13-green](https://img.shields.io/badge/foundry-v13-green)

Bem-vindo ao módulo da Revista T20 - Duelo de Dragões feito para [Tormenta20](https://gitlab.com/vizael/Tormenta20/) para [Foundry Virtual Tabletop](https://foundryvtt.com/).

Revista T20 - Duelo de Dragões é uma produção independente e não afiliada nem a [Jambô Editora](https://jamboeditora.com.br/) e nem ao grupo que fez o porte Não-oficial de Tormenta20 para o FoundryVTT. Enquanto esse módulo é desenvolvido não é mais possível pegar a Revista T20 - Duelo de Dragões, mas considere apoiar a Editora fazendo a compra da revista atual via [Catarse](https://www.catarse.me/revistatormenta20), além disso, é obviamente necessário que você tenha acesso ao [Livro Básico de Tormenta20](https://jamboeditora.com.br/produto/tormenta20-edicao-jogo-do-ano/).
...
3. Use o seguinte link de manifesto `https://github.com/mobguilherme/Revista-T20-Duelo-de-Dragoes/releases/latest/download/module.json`
4. Clique "Instalar."
